...
const fields: CrudField[] = [
  { name: "descricao", label: "Descrição", type: "text", placeholder: "Ex: Pagamento Fornecedor de Peças" },
  { name: "entidade_nome", label: "Fornecedor", type: "text", placeholder: "Nome do fornecedor" },
  ...
  { name: "categoria_financeira", label: "Categoria", type: "text", placeholder: "Ex: Insumos, Aluguel..." },
  { name: "metodo_pagamento", label: "Método", type: "text", placeholder: "Ex: Boleto, Pix..." },
...
const columns = [
  ...
  { key: "entidade_nome" as keyof FinanceiroInput, header: "Fornecedor" },
  { 
