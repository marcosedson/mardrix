...
const fields: CrudField[] = [
  { name: "descricao", label: "Descrição", type: "text", placeholder: "Ex: Reembolso de Despesa" },
  { name: "entidade_nome", label: "Favorecido", type: "text", placeholder: "Nome do favorecido" },
  ...
  { name: "pagamento_data", label: "Data do Pagamento", type: "text", placeholder: "AAAA-MM-DD" },
  { 
    name: "status", 
    label: "Status", 
    type: "select", 
  ...
  { name: "categoria_financeira", label: "Categoria", type: "text", placeholder: "Ex: Operacional, Administrativo..." },
  { name: "metodo_pagamento", label: "Método", type: "text", placeholder: "Ex: Transferência, Dinheiro..." },
...
const columns = [
  ...
  { key: "entidade_nome" as keyof FinanceiroInput, header: "Favorecido" },
  { 
...
export default function RecebimentosContasPagarPage() {
  return (
    <ResourcePage
      title="Recebimentos — Contas a Pagar"
