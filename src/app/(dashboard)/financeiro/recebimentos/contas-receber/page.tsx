...
const fields: CrudField[] = [
  { name: "descricao", label: "Descrição", type: "text", placeholder: "Ex: Recebimento Venda #456" },
...
export default function RecebimentosContasReceberPage() {
  return (
    <ResourcePage
      title="Recebimentos — Contas a Receber"
